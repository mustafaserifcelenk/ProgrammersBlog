...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class CommentController : BaseController
    {
        ...
        public CommentController(UserManager<User> userManager, IMapper mapper, IImageHelper imageHelper, ICommentService commentService) : base(imageHelper, mapper, userManager)
        {
