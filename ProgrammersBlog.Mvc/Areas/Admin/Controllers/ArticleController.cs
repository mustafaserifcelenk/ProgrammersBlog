...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        public ArticleController(IArticleService articleService, ICategoryService categoryService, UserManager<User> userManager, IMapper mapper, IImageHelper imageHelper, IToastNotification toastNotification) : base(imageHelper, mapper, userManager)
        {
        ...
        [Authorize(Roles="SuperAdmin,Articles.Read")]
        [HttpGet]
        ...
        [HttpGet]
        [Authorize(Roles = "SuperAdmin,Articles.Create")]
        ...
        [HttpGet]
        [Authorize(Roles = "SuperAdmin,Articles.Update")]
        ...
        [HttpPost]
        [Authorize(Roles = "SuperAdmin,Articles.Delete")]
