...
namespace ProgrammersBlog.Mvc.Helpers.Concrete
{
    public class ImageHelper : IImageHelper
    {
        ...
        {
            var fileToDelete = Path.Combine($"{_wwwroot}/img/{imgFolder}", pictureName);
        ...
        public async Task<IDataResult<UploadedImageDto>> UploadUserImage(string userName, IFormFile pictureFile, string folderName = "userImages")
        {
            ...
            string oldFileName = Path.GetFileNameWithoutExtension(pictureFile.FileName); // .png, .jpeg olmadan alıyoruz, bunu kullanabilirsin istersen
            ...
            return new DataResult<UploadedImageDto>(ResultStatus.Success, $"{userName} adlı kullanıcın resmi başarıyla yüklenmiştir.", new UploadedImageDto
            {
