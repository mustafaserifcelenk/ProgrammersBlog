...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        ...
        {
            builder.HasKey(a => a.Id); //HasKey : PrimaryKey alanı var mı
            builder.Property(a => a.Id).ValueGeneratedOnAdd(); // 1:1
            ...
            builder.HasOne<Category>(a => a.Category).WithMany(c => c.Articles).HasForeignKey(a => a.CategoryId); //Generic yapı gereksiz okunurluğu artırıyor
